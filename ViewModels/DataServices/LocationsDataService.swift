...
class LocationsDataService {
    ...
    static let locations: [Location] = [
        ...
        Location(
            ...
            cityName: "Northfield",
            coordinates: CLLocationCoordinate2D(latitude: 44.1336, longitude: -72.6548),
            description: "America's oldest private military college.",
            imageNames: ["Norwich Univeristy "],
            link: "https://en.wikipedia.org/wiki/Norwich_University"
        ),
